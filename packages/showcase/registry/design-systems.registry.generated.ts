...
export const designSystemMeta = {
  ...
  'material-design-3-google': {"displayName":"Material Design 3 by Google","components":{"button":{"scale":{"s:sm:1":true,"s:md:1":true,"s:lg:1":true,"s:lg:2":true,"s:lg:3":true},"state":{"primary":{"subtle":{"rest":true,"hover":true,"pressed":true,"disabled":true,"focus":true,"selected":true},"vivid":{"rest":true,"hover":true,"pressed":true,"disabled":true,"focus":true,"selected":true}}}}}},
} as const;
