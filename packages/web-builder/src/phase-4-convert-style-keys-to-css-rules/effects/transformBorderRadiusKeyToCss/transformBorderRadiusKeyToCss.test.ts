    ...
    describe('Success operation', () => {
      ...
      describe('inline -- :hover with size (no breakpoint)', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.abc.-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) { --k-bdr: 22px; border-radius: 22px }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.abc.-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)), .abc.-h.-a { --k-bdr: 22px; border-radius: 22px }'
          );
        });
      });
      ...
      describe('inline -- selected:hover with size (no breakpoint)', () => {
        it('forceState=false', () => {
          ...
          expect(out).toEqual(
            '.abc.-n.-s:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) { --k-bdr: 6px; border-radius: 6px }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          // TODO: deveria ter o "-a"?!
          expect(out).toEqual(
            '.abc.-n.-s:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)), .abc.-s.-h.-a { --k-bdr: 6px; border-radius: 6px }'
          );
        });
      });
      ...
      describe('inline -- selected:hover with size+breakpoint', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 1312px) { .abc.-n.-s:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) { --k-bdr: 4px; border-radius: 4px } }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 1312px) { .abc.-n.-s:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)), .abc.-s.-h.-a { --k-bdr: 4px; border-radius: 4px } }'
          );
        });
      });
      ...
      describe('inline -- focus with size+breakpoint', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 1024px) { .abc.-n:focus-visible { --k-bdr: 18px; border-radius: 18px } }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 1024px) { .abc.-n:focus-visible, .abc.-f.-a { --k-bdr: 18px; border-radius: 18px } }'
          );
        });
      });
      ...
      describe('inline -- pressed with size (no breakpoint)', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual('.abc.-n:active { --k-bdr: 14px; border-radius: 14px }');
        });
        it('forceState=true', () => {
          const force = true as const;
          const key = 'borderRadiusRounded--pressed++s:sm:1__14';
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual('.abc.-n:active, .abc.-p.-a { --k-bdr: 14px; border-radius: 14px }');
        });
      });
    });
    ...
    describe('Success operation', () => {
      ...
      describe('hover', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.abc.-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) { --k-bdr: 24px; border-radius: 24px }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.abc.-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)), .abc.-h.-a { --k-bdr: 24px; border-radius: 24px }'
          );
        });
      });
      ...
      describe('selected:hover', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.abc.-n.-s:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) { --k-bdr: 12px; border-radius: 12px }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.abc.-n.-s:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)), .abc.-s.-h.-a { --k-bdr: 12px; border-radius: 12px }'
          );
        });
      });
    ...
    describe('Success operation', () => {
      describe('==hover', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) .abc { --k-bdr: 12px; border-radius: 12px }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) .abc, .-a.-h .abc { --k-bdr: 12px; border-radius: 12px }'.replace(
              ' \\.',
              ' .'
            )
          );
      ...
      describe('==focus', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual('.-n:focus-visible .abc { --k-bdr: 6px; border-radius: 6px }');
        });
        it('forceState=true', () => {
          const force = true as const;
          const key = 'borderRadiusRounded==focus__6';
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.-n:focus-visible .abc, .-a.-f .abc { --k-bdr: 6px; border-radius: 6px }'
          );
        });
      });
      ...
      describe('==selected:hover', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.-n.-s:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) .abc { --k-bdr: 8px; border-radius: 8px }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.-n.-s:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) .abc, .-a.-s.-h .abc { --k-bdr: 8px; border-radius: 8px }'.replace(
              ' \\.',
              ' .'
            )
          );
      ...
      describe('responsive ==hover (no breakpoint)', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) .abc { --k-bdr: 14px; border-radius: 14px }'.replace(
              ' \\.',
              ' .'
            )
          );
        ...
        it('forceState=true', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '.-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) .abc, .-a.-h .abc { --k-bdr: 14px; border-radius: 14px }'
          );
        });
      });
      ...
      describe('responsive ==hover with breakpoint', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 1312px) { .-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) .abc { --k-bdr: 16px; border-radius: 16px } }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 1312px) { .-n:hover:where(:not(:active)):where(:not(:root[data-k-input="touch"] *)) .abc, .-a.-h \\.abc { --k-bdr: 16px; border-radius: 16px } }'.replace(
              ' \\.',
              ' .'
            )
          );
      ...
      describe('responsive ==focus with breakpoint', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 768px) { .-n:focus-visible .abc { --k-bdr: 10px; border-radius: 10px } }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 768px) { .-n:focus-visible .abc, .-a.-f .abc { --k-bdr: 10px; border-radius: 10px } }'.replace(
              ' \\.',
              ' .'
            )
          );
      ...
      describe('responsive ==selected:focus with breakpoint', () => {
        it('forceState=false', () => {
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 768px) { .-n.-s:focus-visible .abc { --k-bdr: 8px; border-radius: 8px } }'
          );
        });
        it('forceState=true', () => {
          const force = true as const;
          ...
          const out = transformBorderRadiusKeyToCss(key, className, force);
          expect(out).toEqual(
            '@media (min-width: 768px) { .-n.-s:focus-visible .abc, .-a.-s.-f .abc { --k-bdr: 8px; border-radius: 8px } }'
          );
        });
      });
    });
