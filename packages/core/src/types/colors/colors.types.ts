 ...
 * corresponding public scale; references never carry an independent color.
 */
export type PrimitiveFunctionalReferences = Partial<Record<ThemeName, TonalFunctionalReferenceMap>>;
...
export type StaticPrimitiveColorAsset = {
  ...
  functionalReferences?: PrimitiveFunctionalReferences;
  /** Optional gradient template resolved from other primitive scales. */
  gradient?: GradientTemplate;
};

export type StaticPrimitiveTonalColorAsset = StaticPrimitiveColorAsset & {
  functionalReferences: PrimitiveFunctionalReferences;
};
...
export type DynamicPrimitiveColorAsset = {
  ...
  /** May be supplied when the dynamic recipe locks its functional positions. */
  functionalReferences?: PrimitiveFunctionalReferences;
  /**
...
export type DynamicPrimitiveTonalColorAsset = DynamicPrimitiveColorAsset & {
  functionalReferences: PrimitiveFunctionalReferences;
};
