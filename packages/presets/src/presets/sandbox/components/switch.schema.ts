...
import { sandboxTypographyReferences } from '../sandbox.typography.ts';

type SwitchComponent = NonNullable<Schema<SandboxSegment>['components']['switch']>;
...
export function createSandboxSwitchSchema(): SwitchComponent {
  return {
    effects: {
      activationFeedback: {
        profile: 'halo',
