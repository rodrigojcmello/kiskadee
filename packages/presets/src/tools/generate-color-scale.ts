...
export function generateColorScaleArtifact(
  ...
  if (!shaping) {
    // 4-argument form without shaping: generateColorScaleArtifact(hex, prioritize, overrides, invertScale)
    if (hasOverrides === false) {
      headerLines.push(
        `// Generated by generateColorScaleArtifact('${hexColor}', ${forceMidToneLightness50}, {}, ${invertScale})`
      );
    } else {
      headerLines.push(
    ...
    // 5-argument form with shaping: generateColorScaleArtifact(hex, prioritize, overrides, shaping, invertScale)
    if (!hasOverrides) {
      headerLines.push(
        `// Generated by generateColorScaleArtifact('${hexColor}', ${forceMidToneLightness50}, {}, {`
      );
...
// Fluent Primary - Dark
generateColorScaleArtifact('#8283F6', false, {}, undefined, false);
