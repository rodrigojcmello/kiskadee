...
export function generateColorScaleMaterialLikeArtifact(
  ...
  const header = `// Generated by generateColorScaleMaterialLikeArtifact('${hexColor}', { preserveChroma: ${preserveChroma} })\n`;
...
generateColorScaleMaterialLikeArtifact('#1D1B20', { preserveChroma: true });
