...
export function YouTubeIcon({
  ...
  if (presentation === 'brand') {
    return (
      <svg width="1em" height="1em" viewBox="0 0 396.532 277.776" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" {...props}>
  ...
  if (presentation === 'monochrome') {
    return (
      <svg width="1em" height="1em" viewBox="0 0 396.532 277.776" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" {...props}>
