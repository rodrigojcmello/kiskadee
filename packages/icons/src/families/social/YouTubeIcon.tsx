...
export type YouTubeIconConstruction = 'mark';
...
const DEFAULT_PRESENTATIONS: Record<YouTubeIconConstruction, YouTubeIconPresentation> = {"mark":"brand"};
...
export function YouTubeIcon({
  ...
  const resolvedConstruction = construction as YouTubeIconConstruction;
  ...
  throw new Error(
    `Unsupported YouTubeIcon construction/presentation: ${resolvedConstruction}.${String(resolvedPresentation)}`
  );
}
