...
export type GitHubIconPresentation = 'brand' | 'monochrome';
...
const DEFAULT_PRESENTATIONS: Record<GitHubIconConstruction, GitHubIconPresentation> = {"mark":"brand"};
...
export function GitHubIcon({
  ...
  if (resolvedConstruction === 'mark' && resolvedPresentation === 'brand') {
    return (
      <svg width="1em" height="1em" viewBox="-6.681818181818 -8.727272727273 111.363636363636 109.090909090909" fill="#000000" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" {...props}>
