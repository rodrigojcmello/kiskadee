...
export type XIconPresentation = 'monochrome';

export interface XIconProps extends IconProps {
  presentation?: XIconPresentation;
}

export function XIcon({ presentation: _presentation = 'monochrome', ...props }: XIconProps) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 1200 1227" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" {...props}>
